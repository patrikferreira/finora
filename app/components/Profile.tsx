...
export default function Profile() {
  ...
  return (
    <div
      onClick={handleMenu}
      className="flex items-center gap-3 cursor-pointer relative w-full hover:bg-(--bg-secondary) transition duration-150 p-2 rounded-xl border border-transparent hover:border-(--border)"
    >
